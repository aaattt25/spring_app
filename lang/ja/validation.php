...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'url' => 'ホームページアドレス',
        'quality_id' => '泉質',
        'simple_description' => '簡易説明文',
        'detail_description' => '簡易説明文',
        'has_restaurant' => 'レストランの有無',
        'can_drop_by' => '立ち寄り湯の可不可',
        'is_inn' => '宿泊施設の有無',
        'is_flowing_from_source' => '源泉掛け流しかどうか',
        'has_bedrock_bath' => '岩盤浴の有無',
        'has_sauna' => 'サウナの有無',
        'has_parking' => '駐車場の有無',
        'business_hours' => '営業時間',
        'holiday' => '休業日',
        'efficacy' => '効能',
        'has_water_drawing_place' => '水汲み場',
    ],
];
