    ...
    <AuthenticatedLayout>
      ...
      <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
          ...
          <div v-if="user_role === 'administrator'" class="mx-auto flex px-16 pt-100 md:flex-row flex-col items-center">
            <Link class="flex ml-auto text-white border-0 py-2 px-6 focus:outline-none bg-yellow-600  hover:bg-yellow-500 rounded" as="button" :href="route('springs.create')">
              新規温泉登録
            </Link>
          </div>
          ...
          <section class="text-gray-600 body-font">
            <div v-for="spring in springs" :key="spring.id" class="container mx-auto flex px-5 my-20 pt-20 md:flex-row flex-col items-center p-4 sm:p-8 bg-white shadow sm:rounded-lg">
