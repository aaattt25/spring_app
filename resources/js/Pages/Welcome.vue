...
<template>
    ...
    <div class="relative bg-gradient-to-r from-purple-600 to-blue-600 h-screen text-white overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="/images/main_image.jpeg" alt="Background Image" class="object-cover object-center w-full h-full" />
        ...
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
            ...
            <template v-else>
                <Link
                    :href="route('login')"
                    class="font-semibold text-whit hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                    >ログイン</Link
                >
